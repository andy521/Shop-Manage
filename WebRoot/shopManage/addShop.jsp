...
<form action="shopManage!addSave.action" method="post" class="form form-horizontal responsive" id="demoform">
			<div class="row cl">
        ...
        <div class="row cl">
			...
			<div class="formControls col-xs-5">
				<input type="text" required  placeholder="请输入开店日期!"  errormsg="请输入正确格式（2016-01-01）！" datatype="date" nullmsg="开店日期不能为空!" value="${birthday}"  onClick="WdatePicker()"  class="input-text radius Wdate"  name="shop.birthday" id="shop.birthday" >
			</div>
			<div class="col-xs-5"> </div>
		</div>
		...
		<input class="btn btn-success radius  mt-20" type="submit" value="新增店铺">
		</div></div>
	</form>
	</div>
