...
<![endif]-->
 ...
 <body>
  <div class="container">
   ...
   <form action="house!logs.action"  method="post" id="demoform" class="form form-horizontal responsive" name="sel">
   ...
   <input type="hidden"  name="page" value="<s:property value="page"/>">
	...
	<tr>
		...
		<td>
			...
			<option></option>
			<option value="addhouse">添加库存</option>
			<option value="updhouse">修改库存</option>
			<option value="delhouse">删除库存</option>
  ...
  <table class="table table-border table-bordered table-hover table-bg mt-10">
		...
		<s:iterator value="logs" status="b" id="s">
			...
			<s:elseif test='#s.upkind=="updhouse"'>修改库存</s:elseif>
			<s:elseif test='#s.upkind=="delhouse"'>删除库存</s:elseif>
			...
			<td class="col2 text-c">
			<a href="house!selLog.action?id=<s:property value="#s.id"/>" class="btn btn-primary radius ">详细信息</a>&nbsp;&nbsp;&nbsp;
			</td>
